...
<body>
  ...
  <section class="bio section" id="bio">
    ...
    <div class="bioCopy">
      ...
      <p>Chamber Cartel has produced three studio albums and an EP. Interiors, featuring the music of Atlanta composer Adam Scott Neal and The Shape Distance, featuring the music of English composer Marc Yeats, as well as A Million Acres of Sky by
    ...
    <div class="contactUsContentContainer">
      ...
      <div class="forms">
        ...
        if (isset($_POST['submit'])) {
          ...
          $headers = "From: " . $mailFrom;
          $headers .= "Reply-To: $fullName <$mailFrom>\r\n";
          $headers .= "Return-Path: $fullName <$mailFrom>\r\n";
          ...
          if (isset($checkbox) && $checkbox != "") {
            $checkboxEntity = htmlentities($checkbox);
          } else {
            $checkboxEntity = NULL;
            $errors[] = "Please confirm that you are human";
          }

          if (count($errors) != 0) {
            echo "<ul>";
            foreach ($errors as $error) {
              echo "<li class='error' style='color: red'>" . $error . "</li>";
            }
            echo "</ul>";
          } else {
          ...
          // header("Location: index.php#formAnchor");

        }
        ?>
        <form action="index.php#formAnchor" method="post">
          <fieldset>
            <input class="name" name="fullName" type="text" placeholder="Full name">
            ...
            <div class="captcha"><input class="checkbox" type="checkbox" name="captcha" value="notARobot"> I'm human
            </div>
            <div class="sendContainer"><button class="sendButton" name="submit" type="submit">Send</button></div>
          </fieldset>
        </form>
      </div>
    </div>
  ...
  <footer class="footer">
    ...
    <div class="footerTextContainer">
      <div class="footerText">
        <p>&copy; Chamber Cartel 2019 | All Rights Reserved</p>
        <p>All stock images found on <a href="https://unsplash.com/" target="_blank">unsplash.com</a></p>
      </div>
      <div class="footerSocialMedia">
        <!-- <div class="fabContainer"> -->
        <a href="https://www.facebook.com/ChamberCartel/" target="_blank" class="fabContainer"><i class="fab fa-facebook-f"></i></a>
        <!-- </div> -->
        <!-- <div class="fabContainer"> -->
        <a href="https://twitter.com/chambercartel" target="_blank" class="fabContainer"><i class="fab fa-twitter"></i><a></a>
          <!-- </div> -->
          <!-- <div class="fabContainer"> -->
          <a href="https://www.instagram.com/chambercartel/" target="_blank" class="fabContainer"><i class="fab fa-instagram"></i></a>
          <!-- </div> -->
